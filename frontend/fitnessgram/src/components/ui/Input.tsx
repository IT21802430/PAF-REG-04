...
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(
    ...
    return (
        <label className="w-full" htmlFor={id}>
            ...
            <div className="flex">
                {prefix ? (
                <span className="ld-text-gray-500 inline-flex items-center rounded-l-xl border border-r-0 border-gray-300 bg-gray-100 px-3  ">
                    {prefix}
                </span>
                ) : null}
                <div
                className={cn(
                    ...
                    "flex w-full items-center border border-gray-300 bg-white focus-within:border-gray-500 focus-within:ring-gray-400  "
                )}
                >
                <input
                    className={cn(
