            ...
            <div className="ld-text-gray-500 max-w-none !p-8">
              ...
              <div className="space-y-5">
                ...
                <ul className="list-inside list-disc space-y-2">
                  ...
                  <li>
                    Share excessive amounts of content of any type
                    (&quot;Spam&quot;)
                  </li>
              ...
              <div className="space-y-5">
                ...
                <p className="leading-7">
                  ...
                  like this, please use the &quot;About me&quot; section on your
                  Profile to inform other users that your Account is a parody
                  account. You must do this in a way which can be easily seen
                  and understood by other users.
                </p>
              </div>
              {/* Impersonation ends */}
              ...
              <p className="linkify leading-7">
                ...
                questions, please <button>Contact us</button>.
              </p>
              {/* Feedback ends */}
            </div>
          </div>
